    ...
    <section class="column">
      ...
      <section class="FlexContainer">
        ...
        <section class="column SocialMediaIcons FooterSocialMediaIcons">
          <a href="{$LinkedIn}" target="_blank" class="SocialMediaIcon">
          ...
          <a href="{$Twitter}" target="_blank" class="SocialMediaIcon FooterSocialMediaIcon">
          ...
          <a href="{$Facebook}" target="_blank" class="SocialMediaIcon FooterSocialMediaIcon">
