...
function theme_assets()
{
    ...
    wp_enqueue_script('javascript', THEME_URI . '/build/js/global-min.js', array(), null, true);
    wp_enqueue_style('css', THEME_URI . '/build/css/global.css', array(), null);
    wp_enqueue_style('typography', 'https://fonts.googleapis.com/css?family=Open+Sans:400,700|Oswald', array(), null);
